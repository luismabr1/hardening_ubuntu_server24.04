...
function main {
    ...
    # Define function execution list
    local hardening_functions=(
        ...
        f_ctrlaltdel f_auditd f_aide f_rhosts f_users f_lockroot
        f_package_remove f_suid f_restrictcompilers f_umask f_path
        f_aa_enforce f_aide_post f_aide_timer f_aptget_noexec f_aptget_clean
